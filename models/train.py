...
def trainIters(encoder, decoder, training_data, num_epochs, learning_rate=0.01):
    ...
    for epoch in range(num_epochs):
        ...
        for _, (input_tensor, target_tensor) in tqdm(enumerate(training_data)):
            # print(input_tensor)
...
if __name__=="__main__":
    ...
    evalution_input = "Oxygen is the eighth element in the periodic table - its atomic weight is 16 and it is represented by the symbol O."
